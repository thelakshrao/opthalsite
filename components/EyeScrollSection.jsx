...
export default function EyeScrollSection() {
  ...
  if (isMobile === true) {
    return (
      <section
        id="hero-animation"
        className="relative w-full h-screen sm:h-[100dvh] bg-black overflow-hidden transform-gpu"
      >
        <div className="absolute inset-0 w-full h-full z-0">
          <Image
            src={MOBILE_STATIC_FRAME}
            alt="Precision human eye anatomy"
            fill
            priority
            sizes="100vw"
        ...
        <div className="absolute inset-0 z-10 pointer-events-none bg-black/55" aria-hidden="true" />
        <div
